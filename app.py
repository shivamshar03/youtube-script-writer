...
topic = st.text_input('Please provide the topic of the video',key="topic")  # The box for the text topic
video_length = st.text_input('Expected Video Length 🕒 (in minutes)',key="video_length")  # The box for the text topic
...
if submit:
    with st.spinner("wait..."):
        ...
        if st.session_state['API_Key']:
            search_result,title,script = generate_script(topic,video_length,creativity,st.session_state['API_Key'])
